...
## 0、课程介绍
![1659535866861](image/SpringMVC笔记/1659535866861.png)
![1659535894807](image/SpringMVC笔记/1659535894807.png)
...
![images](image/SpringMVC笔记/img001.png)
...
> value属性、method属性各自属性之间的是或的关系；
> params属性、headers属性各自属性之间的是且的关系。
...
![image-20210706201316593](image/SpringMVC笔记/img003.png)
...
![image-20210706201602267](image/SpringMVC笔记/img004.png)
...
满足以上条件，**HiddenHttpMethodFilter** 过滤器就会将当前请求的请求方式转换为请求参数 `_method` 的值，因此请求参数 `_method` 的值才是最终的请求方式（不区分大小写）
...
- 搭建环境
- 准备实体类 com.atguigu.mvc.bean.Employee
    ```java
    public class Employee {
        ...
        // getter、setter、
    ```
- 准备dao模拟数据 com.atguigu.mvc.dao.EmployeeDao
    ```java
    @Repository
...
![images](image/SpringMVC笔记/img005.png)
...
2. DispatcherServlet对请求URL进行解析，得到请求资源标识符（URI），判断请求URI对应的映射：
   1. 不存在
      ...
      2. 如果没配置，则控制台报映射查找不到，客户端展示404错误
        ![image-20210709214911404](image/SpringMVC笔记/img006.png)
        ![image-20210709214947432](image/SpringMVC笔记/img007.png)
      3. 如果有配置，则访问目标资源（一般为静态资源，如：JS,CSS,HTML），找不到客户端也会展示404错误
        ![image-20210709215255693](image/SpringMVC笔记/img008.png)
        ![image-20210709215336097](image/SpringMVC笔记/img009.png)
   2. 存在则执行下面的流程
